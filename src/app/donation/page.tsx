...
export default function DonationPage() {
  return (
    <>
      ...
      <main className="min-h-dvh relative overflow-hidden flex items-center justify-center py-40 px-4"
        ...
        <div className="relative z-10 w-full max-w-135">
          ...
          <div className="text-center mb-12 space-y-3">
            ...
            <h1 className="text-5xl md:text-6xl font-light tracking-tight font-serif text-white">
              Support our <span className="text-shimmer italic font-serif text-red-500">Mission</span>
            </h1>
            <p className="text-slate-400 text-lg max-w-xs mx-auto font-light leading-relaxed">
