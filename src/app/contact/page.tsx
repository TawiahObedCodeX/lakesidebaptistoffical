      ...
      <section className="relative min-h-[65vh] flex items-center justify-center overflow-hidden bg-blue-900 px-6 py-20">
        ...
        <div className="relative z-10 text-center max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 mb-4">
            ...
            <span className="text-brand-accent uppercase tracking-[3px] text-sm font-semibold">Get In Touch</span>
            <div className="h-px w-8 bg-brand-accent" />
          </div>

          <h1 className="text-5xl md:text-6xl font-serif font-bold text-white leading-tight mb-6">
            We&apos;d Love to <span className="text-brand-accent">Hear From You</span>
          </h1>
      ...
      <div className="max-w-7xl mx-auto px-6 py-16 lg:py-20">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="space-y-10">
            <div>
              <span className="text-brand-accent uppercase tracking-widest text-2xl font-semibold">Contact Information</span>
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8 lg:p-10 border border-slate-100">
            <div className="mb-8">
              <span className="uppercase text-brand-accent text-xl font-semibold tracking-widest">Send a Message</span>
      ...
      <section className=" py-16 lg:py-20 text-black">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <span className="text-brand-accent font-bold uppercase tracking-widest text-2xl ">Our Location</span>
