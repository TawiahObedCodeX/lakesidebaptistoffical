...
// form AFTER the contact info. Add this inside the motion.div: */}
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-white/70 hover:text-brand-accent transition-colors text-sm block mb-1"
                  >
                    (+233) 24 838 3745
                  </a>
                  <a
                    href="mailto:lakesidebaptistchurch1@gmail.com"
                    className="text-white/70 hover:text-brand-accent transition-colors text-sm truncate block max-w-60"
                  >
        ...
        >
          <p className="text-[11px] text-white/30 font-medium tracking-wide">
            © 2026{" "}
            <span className="text-white/50">Lakeside Baptist Church</span>.
            ...
            {["Privacy Policy", "Terms of Service", "Cookie Policy"].map(
              (item) => (
                <a
                  key={item}
                  href="#"
                  className="text-[10px] uppercase tracking-widest font-bold text-white/30 hover:text-brand-accent transition-colors"
                >
                  {item}
                </a>
              ),
